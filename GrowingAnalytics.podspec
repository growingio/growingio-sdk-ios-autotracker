...
GrowingAnalytics具备自动采集基本的用户行为事件，比如访问和行为数据等。目前支持代码埋点、无埋点、可视化圈选、热图等功能。
  ...
  s.subspec 'MultiTracker' do |multi|
    multi.source_files = 'Modules/MultiTracker/**/*{.h,.m,.c,.cpp,.mm}'
    multi.public_header_files = 'Modules/MultiTracker/Public/*.h'
    multi.dependency 'GrowingAnalytics/TrackerCore', s.version.to_s
  end
