...
GrowingAnalytics具备自动采集基本的用户行为事件，比如访问和行为数据等。目前支持代码埋点、无埋点、可视化圈选、热图等功能。
  ...
  s.subspec 'Encryption_v2' do |service|
    service.source_files = 'Services/Encryption_v2/**/*{.h,.m,.c,.cpp,.mm}'
    service.public_header_files = 'Services/Encryption_v2/Public/*.h'
    service.dependency 'GrowingAnalytics/TrackerCore'
    service.ios.framework = 'Security'
  end
  ...
  s.subspec 'DefaultServices' do |services|
    ...
    services.dependency 'GrowingAnalytics/Encryption_v2'
