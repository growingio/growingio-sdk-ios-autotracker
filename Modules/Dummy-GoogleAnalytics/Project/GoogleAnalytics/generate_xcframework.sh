...
FRAMEWORK_NAME="GoogleAnalytics"
BUILD_DIR="../../build"
...
echo "---------------------"
/bin/cp -f "version3.20/ios-arm64_armv7/GoogleAnalytics.a" "GoogleAnalytics/GoogleAnalytics.a"
...
echo "---------------------"
/bin/cp -f "version3.20/ios-arm64_i386_x86_64-simulator/GoogleAnalytics.a" "GoogleAnalytics/GoogleAnalytics.a"
...
echo "---------------------"
rm -rf ${BUILD_DIR}/Release-iphoneos/${FRAMEWORK_NAME}.framework/_CodeSignature
