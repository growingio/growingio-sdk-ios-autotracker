...
@property (nonatomic, copy, readonly) NSString * _Nullable customerAttribute;
...
- (instancetype _Nonnull )initWithUUID:(NSString * _Nonnull )uuid eventType:(NSString * _Nonnull )evnetType jsonString:(NSString * _Nonnull)jsonString;
