...
SDK_VERSION_FILE2=./GrowingAnalytics-cdp.podspec
SDK_VERSION_FILE3=./GrowingAnalytics.podspec
...
sed -i '' -E "s/s.version          = \'$REGEX1\'/s.version          = \'$NEW_VERSION\'/" $SDK_VERSION_FILE3