...
@interface GIOContainerViewController ()
...
@implementation GIOContainerViewController
...
- (void)createView {
    ...
    /* 这种方法添加 view 不会触发 first 的 viewwillappear 等一系列方法
     GIOFirstViewController *first = [GIOFirstViewController new];
...
- (NSArray <UIViewController *> *)makeChildViewController {
    GIOFirstViewController *first = [GIOFirstViewController new];
    GIOSecondViewController *second = [GIOSecondViewController new];
    return @[first,second];
}
