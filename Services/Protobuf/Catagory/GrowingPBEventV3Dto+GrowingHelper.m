...
- (id)growingHelper_jsonObject {
    ...
    if (self.path.length >= 0 &&
        (self.eventType == GrowingPBEventType_Page || self.eventType == GrowingPBEventType_Custom ||
         self.eventType == GrowingPBEventType_ViewClick || self.eventType == GrowingPBEventType_ViewChange)) {
